...
public class NaverMap implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        String clientId = "vj0posxnc8";
        String clientSecret = "LS9zckeXilq5ZTpwT4A5IYHeHh6zxIa0YzPDFPVU";
    ...
    public void map_service(AddressVO vo) {
        ...
        try {
            ...
            HttpURLConnection con = (HttpURLConnection)url.openConnection();
            con.setRequestMethod("GET");
            con.setRequestProperty("X-NCP-APIGW-API-KEY-ID", "vj0posxnc8");
            con.setRequestProperty("X-NCP-APIGW-API-KEY", "LS9zckeXilq5ZTpwT4A5IYHeHh6zxIa0YzPDFPVU");
